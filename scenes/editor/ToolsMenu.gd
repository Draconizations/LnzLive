...
func _ready():
	...
	add_item("Connect by Linez") # index 3
	add_item("Copy L to R") # was index 2 now 4
	add_item("Move head") # was index 3 now 5
	add_item("Copy ball colors to clipboard") # was index 4 now 6
