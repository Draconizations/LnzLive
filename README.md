> [!NOTE]  
> The Petz & Babyz (PB) version of LnzLive is in open beta and the latest release is [available here](https://github.com/tabbzi/LnzLive/releases/). Check out [features planned for development](https://github.com/tabbzi/LnzLive/projects), submit pull requests of your own changes, or [submit a ticket](https://github.com/tabbzi/LnzLive/issues) to suggest features or report bugs!
